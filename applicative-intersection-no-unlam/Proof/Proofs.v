...
Proof.
  ...
  (* there's inspiring thought here: should we deal with stack at typing_merge *)
  (* clearly, induction on merge term will give us some useful information *)

  (* let's invent a version, distribute the stack into merge *)
Admitted.
