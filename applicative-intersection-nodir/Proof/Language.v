...
| tred_int_anno : forall (n : nat),
    typedred (trm_anno (trm_int n) typ_int) typ_int (trm_anno (trm_int n) typ_int)
...
| tred_arrow_anno : forall (A B C D E : typ) (e : trm),
    not (toplike D) -> sub A (typ_arrow C D) ->
    typedred (trm_anno (trm_abs E e) A)
             (typ_arrow C D)
...
| typing_lam1 : forall (L : vars) (T : ctx) (A B : typ) (e : trm),
    ...
    typing T nil (trm_abs A e) (typ_arrow A B)
| typing_lam2 : forall (L : vars) (S : arg) (T : ctx) (A B C : typ) (e : trm),
    (forall x, x \notin L -> (typing ((x ~ A) ++ T)) S (open e (trm_fvar x)) B) ->
    sub C A ->
    typing T (cons C S) (trm_abs A e) (typ_arrow A B)
| typing_anno : forall (S : arg) (T : ctx) (A B C : typ) (e : trm),
    typing T nil e C -> sub C A -> appsub S A B ->
    typing T S (trm_anno e A) B
| typing_app : forall (L : vars) (S : arg) (T : ctx) (A B : typ) (e1 e2 : trm),
    typing T nil e2 A ->
