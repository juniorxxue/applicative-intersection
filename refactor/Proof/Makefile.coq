...
Makefile.coq.conf: _CoqProject
	coq_makefile -f _CoqProject Language.v Subtyping/Toplike.v Subtyping/Splitable.v Subtyping/Subtyping.v Appsub.v Disjoint.v Value.v Typing.v Tactical.v -o Makefile.coq
