...
| Ty_App : forall T A B e1 e2,
    typing T e1 Inf (Arr A B) ->
    typing T e2 Chk A ->
    typing T (App e1 e2) Inf B
| Ty_App_L : forall T A1 A2 B C e1 e2,
    typing T e1 Inf (And A1 A2) ->
    typing T e2 Inf B ->
    appsub (Some B) A1 C ->
    not (auxas (Some B) A2) ->
    typing T (App e1 e2) Inf
| Ty_App_R : forall T A1 A2 B C e1 e2,
    typing T e1 Inf (And A1 A2) ->
    typing T e2 Inf B ->
    appsub (Some B) A2 C ->
    not (auxas (Some B) A1) ->
    typing T (App e1 e2) Inf C
| Ty_App_P : forall T A1 A2 B C1 C2 e1 e2,
    typing T e1 Inf (And A1 A2) ->
    typing T e2 Inf B ->
    appsub (Some B) A1 C1 ->
    appsub (Some B) A2 C2 ->
    typing T (App e1 e2) Inf (And C1 C2)           
