...
Lemma typing_app :
  forall A B C v vl,
    ...
    typing nil vl Inf B ->
    appsub (Some B) A C ->
    (* typing nil (App v vl) inf C *)
    exists D, typing nil (App v vl) Inf D.
Proof.
  introv Val1 Val2 Typ1 Typ2 As. gen v vl.
  dependent induction As; eauto; intros.
  - dependent destruction Typ1; eauto.
    + destruct (auxas_decidable B B0); eauto.
      eapply auxas_to_appsub in H0. destruct H0.
      exists (And D x); eauto.
   + destruct (auxas_decidable B B0); eauto.
      eapply auxas_to_appsub in H3. destruct H3.
      exists (And D x); eauto.
  - dependent destruction Typ1; eauto.
    + destruct (auxas_decidable B A); eauto.
      eapply auxas_to_appsub in H0. destruct H0.
      exists (And x D); eauto.
   + destruct (auxas_decidable B A); eauto.
      eapply auxas_to_appsub in H3. destruct H3.
      exists (And x D); eauto.
Qed.

Lemma typing_app_strict :
  forall A B C v vl,
    value v -> value vl ->
    typing nil v Inf A ->
    typing nil vl Inf B ->
    appsub (Some B) A C ->
    (* typing nil (App v vl) inf C *)
    exists D, typing nil (App v vl) Inf D /\ isosub D C.
Proof.
  introv Val1 Val2 Typ1 Typ2 As. gen v vl.
  dependent induction As; eauto; intros.
  - dependent destruction Typ1; eauto.
...
Proof.
  ...
  Ltac solver2 := repeat match goal with
                  ...
                  | Typ1: typing nil ?v Inf ?A,
                      Typ2: typing nil ?vl Inf ?B,
                        As: appsub (Some ?B) ?A ?C |- _ => pose proof (typing_app A B C v vl) as _Typ;
                                                         destruct _Typ; eauto; clear As
                  end.
  ...
  - Case "Merge L".
    ...
    + dependent destruction Typ; eauto 3.
      * dependent destruction Typ1.
      * dependent destruction Typ1; solver2.
      * dependent destruction Typ1; solver2.
      * dependent destruction Typ1; solver2.
    + dependent destruction Typ; eauto 3.
      * dependent destruction Typ1.
  ...
  - Case "Merge P".
    ...
    + dependent destruction Typ; eauto 3.
      ...
      * dependent destruction Typ1; solver2.
      * dependent destruction Typ1; solver2.
      * f_equal; dependent destruction Typ1; solver2.
Qed.
...
Proof.
  ...
  - Case "App".
    ...
    + exists B. split; eauto.
      eapply Ty_App; eauto. eapply isosub_to_sub1 in H1.
      eapply typing_chk_sub; eauto.
    + dependent destruction H0.
      dependent destruction H1.
      eapply appsub_iso2 in H2_; eauto. destruct H2_.
      eapply appsub_iso2 in H2_0; eauto. destruct H2_0. destruct_conjs.
      exists (And x0 x1). split; eauto.
      eapply Ty_App_P; eauto.
      * eapply appsub_arg_sub; eauto. eapply sub_transitivity; eauto. eapply isosub_to_sub1; eauto.
      * eapply appsub_arg_sub; eauto. eapply sub_transitivity; eauto. eapply isosub_to_sub1; eauto.
  - Case "App L".
    pose proof (IHTyp1 F) as IH1. pose proof (IHTyp2 F) as IH2.
    destruct IH1; destruct IH2; eauto. destruct_conjs.
    ...
    + exists C0. split; eauto.
      eapply Ty_App_L; eauto. eapply appsub_arg_sub; eauto. eapply isosub_to_sub1; eauto.
      intros Contra. eapply auxas_iso1 in Contra; eauto.
    + dependent destruction H2.
      eapply appsub_iso in H; eauto. destruct H. destruct H.
      exists x0. split; eauto.
      eapply Ty_App_L; eauto.
      intros Contra. eapply auxas_iso1 in Contra; eauto. eapply auxas_iso2 in Contra; eauto.
  - Case "App R".
    pose proof (IHTyp1 F) as IH1. pose proof (IHTyp2 F) as IH2.
    destruct IH1; destruct IH2; eauto. destruct_conjs.
    dependent destruction H4.
    + exists C0. split; eauto.
      eapply Ty_App_R; eauto. eapply appsub_arg_sub; eauto. eapply isosub_to_sub1; eauto.
      intros Contra. eapply auxas_iso1 in Contra; eauto.
    + dependent destruction H2.
      eapply appsub_iso in H; eauto. destruct H. destruct H.
      exists x0. split; eauto.
      eapply Ty_App_R; eauto.
      intros Contra. eapply auxas_iso1 in Contra; eauto. eapply auxas_iso2 in Contra; eauto.
  - Case "App P".
    pose proof (IHTyp1 F) as IH1. pose proof (IHTyp2 F) as IH2.
    destruct IH1; destruct IH2; eauto. destruct_conjs.
    dependent destruction H4.
    + exists (And C1 C2). split; eauto.
      eapply Ty_App_P; eauto.
      eapply appsub_arg_sub; eauto. eapply isosub_to_sub1; eauto.
      eapply appsub_arg_sub; eauto. eapply isosub_to_sub1; eauto.
    + dependent destruction H2.
      eapply appsub_iso in H; eauto. destruct H.
      eapply appsub_iso in H0; eauto. destruct H0.
      destruct_conjs. exists (And x0 x2).
      split; eauto.
  - Case "Merge".
    pose proof (IHTyp1 F) as IH1. pose proof (IHTyp2 F) as IH2.
    destruct IH1; destruct IH2; eauto. destruct_conjs.
...
Proof.
  ...
  introv Val Vall Typ Pa. gen A. 
  induction Pa; intros.
  - Case "Lit Toplike".
    dependent destruction Typ. exists B. split; eauto.
  ...
  - Case "Lam Toplike".
    ...
    + dependent destruction Typ1; eauto.
  - Case "Lam".
    dependent destruction Typ; dependent destruction Val.
    + dependent destruction Typ1. dependent destruction Typ1. dependent destruction Typ1.
      match goal with
      | [H: sub (Arr _ _) (Arr _ _) |- _] => (dependent destruction H; eauto)
      end.
      exists B0. split; eauto. dependent destruction Typ2.
      match goal with
  ...
  - Case "Merge L".
    ...
    + dependent destruction Typ1.
    + dependent destruction Typ1; intros; solver1.
      * 
    + dependent destruction Typ1; solver1; eauto.
    + dependent destruction Typ1; solver1; eauto.
