...
Lemma auxas_decidable :
  forall A B,
    auxas (Some A) B \/ ~ auxas (Some A) B.
Proof.
  introv. gen A.
  induction B; intros.
  - right. intros Contra. inversion Contra.
  - right. intros Contra. inversion Contra.
  - destruct (sub_decidable A B1).
    + left. eauto.
    + right. intros Contra. dependent destruction Contra. contradiction.
  - destruct (IHB1 A); destruct (IHB2 A); eauto.
...
Proof.
  introv As Sub. gen D.
  dependent induction As; intros; eauto.
  eapply As_Arr. eapply sub_transitivity; eauto.
Qed.
  
Lemma auxas_to_appsub :
  forall A B,
    auxas (Some A) B ->
    exists C, appsub (Some A) B C.
Proof.
  introv Aas.
  dependent induction Aas; eauto.
  - destruct (IHAas A); eauto.
  - destruct (IHAas A); eauto.
Qed.
