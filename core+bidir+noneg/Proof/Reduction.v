...
Proof.
  ...
  - dependent destruction St2; solver1.
    f_equal. dependent destruction Typ; eauto.
    dependent induction Typ2; eauto.
  - dependent destruction St2; solver1.
    dependent destruction Typ;
      f_equal; eauto.
  - dependent destruction St2; solver1.
...
Proof.
  ...
  - Case "App".
    dependent destruction St.
    + pose proof (papp_preservation e1 e2 e B) as Pa.
      destruct Pa; eauto.
    + admit.
    + admit.
  - Case "App L".
    dependent destruction St.
    + pose proof (papp_preservation e1 e2 e C) as Pa.
      destruct Pa; eauto.
    + admit.
    + admit.
  - Case "App R".
  ...
  - Case "App P".
    dependent destruction St.
    + pose proof (papp_preservation e1 e2 e (And C1 C2)) as Pa.
      destruct Pa; eauto.
    + admit.
    + admit.
  - Case "Merge".
